...
# 1 "./system.h" 1
# 85 "./system.h"
__attribute__((inline)) void initMotorTask(void) {
    TRISC = 0x00;
    PORTC = 0x00;
}

__attribute__((inline)) void resetMotor(void) {
    PORTC = 0x00;
}

__attribute__((inline)) void MotorTask(void) {
    initMotorTask();
    unsigned char j = 0;
    unsigned short int const NO_STEPS = 48;
    for (int i=0; i<NO_STEPS; i++){
        PORTC = (unsigned char)(1 << j);
...
__attribute__((inline)) void initLampTask(void) {
...
__attribute__((inline)) void resetLamp(void) {
    PORTBbits.RB2 = 0;
    INTCONbits.TMR0IE = 0;

}

__attribute__((inline)) void LampTask(void) {
    initLampTask();
    for (int i=0; i<3; i++) {
        if(PORTBbits.RB1){
            PORTBbits.RB2 = 1;
...
__attribute__((inline)) void initCounterTask(void) {
    TRISD = 0x00;
    PORTD = 0x3F;
}

__attribute__((inline)) void resetCounter(void) {
    PORTD = 0x00;
}

__attribute__((inline)) void CounterTask(int maxCount) {
    initCounterTask();
...
void __attribute__((picinterrupt(("")))) SwitchPress(void) {
